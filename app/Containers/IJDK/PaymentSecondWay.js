...
export default class PaymentSecondWay extends Component {
    constructor(props) {
        super(props);
        this.state = {
            webViewHeight: 100,
    ...
    componentDidMount() {
        ...
        let {transaction_code} = state.params
        // let jsonParam = JSON.parse(response)
        console.log("Json param : "+(transaction_code))
        return fetch('http://182.23.65.29:8888/free-0.0.1/service/payment/padipay/reqPadipayLoyalty?transaction_code='+transaction_code+'', {
            method: 'POST',
            headers: {
...
AppRegistry.registerComponent("padiciti", () => PaymentSecondWay);
