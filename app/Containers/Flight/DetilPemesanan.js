...
export default class DetilPemesanan extends Component {
    ...
    returnData() {
        ...
        switch (params.slug) {
            case 'history':
                ...
                return Return
            default:
            console.log('ASUUUUUUU>>>>')
            console.log(params.DataJson.flightReturn.flightNo)
    ...
    ShareMessage (){
        ...
        this.state.passanger.map((item, i) => (
            ...
            Share.share(
            {
             ...
             +'\nTanggal Keberangkatan : '+ Function.FormeteDate(this.state.flightDepart.depDate, 'YYYYMMDD','ddd, DD MM YYYY')
             ...
             +'\nTanggal Pulang : '+ Function.FormeteDate(this.state.flightReturn.depDate, 'YYYYMMDD','ddd, DD MM YYYY')
    ...
    componentDidMount() {
        ...
        AsyncStorage.getItem('SearchFlight', (err, SearchFlight) => {
            ...
            switch (params.slug) {
                ...
                default:
                console.log('ASUUUU>>>>>')
                console.log(params.DataJson.flightReturn)
                    this.setState({
                        flightDepart: {
        ...
        try {
            ...
            JSONPostFile(url, param).then((Respone) => {
                ...
                switch (Respone.respCode) {
                    ...
                    case '0':
                        this.setState({ loading: false }, () => {
                            this.props.navigation.navigate('PaymentFlight', { DataJson: Respone })
    ...
    render() {
        ...
        const { params } = this.props.navigation.state;
        console.log("MILISECOND : "+this.millisecound())
        return (
                           ...
                           <View>
                                    <View style={{ backgroundColor: Colors.white, paddingLeft: Metrics.normalPadding, paddingRight: Metrics.normalPadding}} >
                                        <CardComponentReview
                                            ...
                                            txt_food ={this.state.flightDepart.airlineGroup && this.state.flightDepart.airlineGroup.toLowerCase()}
                                            img_food ={this.state.flightDepart.airlineGroup && this.state.flightDepart.airlineGroup.toLowerCase()}
