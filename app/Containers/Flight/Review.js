...
import { Alert, getAirlineLogo, RadioButtons, Colors, CalendarsScreen, Metrics, Container, getIcon, Toolbar, CardComponentReview, TextView, FrameRadiusComponent, CheckBox, Loading, DialogComponent, Fonts, ItemField } from '../../Components'
        ...
        try {
            ...
            JSONPostFile(url, param).then((Respone) => {
                ...
                switch (Respone.respCode) {
                    ...
                    case '0':
                        this.setState({ loading: false }, () => {
                            this.props.navigation.navigate('DetilPemesanan', { DataJson: Respone, airlineGroupDepart: Function.ObjectNull(params, 'dataDepart.airlineCode'), airlineGroupReturn: Function.ObjectNull(params, 'dataReturn.airlineCode'), data: param })
                        })
                        break
                    default:
                    ...
                    <View style={{ backgroundColor: Colors.whitesmoke }} >
                        <View style={{ backgroundColor: Colors.white, padding: 16, }} >
                            ...
                            <CardComponentReview
                                ...
                                city={this.state.search_param && (this.state.search_param[5].depart.title.split('(')[0] + ' - ' + this.state.search_param[6].return.title.split('(')[0])}
                                ...
                                onpress_detil={() => this.props.navigation.navigate('detil', { data: Function.ObjectNull(params, 'dataDepart'), airlineGroup: Function.ObjectNull(params, 'dataDepart.airlineGroup'), slug: 'depart' })}
                            />
                            ...
                            {Function.ObjectNull(params, 'dataReturn') && <CardComponentReview
                                ...
                                city={this.state.search_param && (this.state.search_param[6].return.title.split('(')[0]) + ' - ' + this.state.search_param[5].depart.title.split('(')[0]}
                                ...
                                onpress_detil={() => this.props.navigation.navigate('detil', { data: Function.ObjectNull(params, 'dataReturn'), airlineGroup: Function.ObjectNull(params, 'dataReturn.airlineGroup'), slug: 'return' })}
                            />}
                        </View>
                        ...
                        <View style={{ backgroundColor: Colors.white, paddingTop: Scale(16), paddingBottom: Scale(16) }}>
                            ...
                            <TouchableComponent
                                ...
                                <View style={{
                                    ...
                                    <TextView style={{ color: Colors.white, fontSize: Fonts.size.large, }}>{STRING.Label.more}</TextView>
                                </View>
                            </TouchableComponent>
                        </View>
