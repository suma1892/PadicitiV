        ...
        return (
            <View style={{ flex: 1, }}>
                        ...
                        renderItem={({ item }) => (
                            <View>
                                <ItemListSchedulrFlight
                                    onPress={() => (this.state.parameter[8].selectedItem === 'round-trip' ? this.props.navigation.navigate('ScheduleReturn', {
                                    ...
                                    }) : this.props.navigation.navigate('Review', { dataDepart: item, airlineGroupDepart: item.airlineCode, slug: 'one_way' }))}
                                    onpress_detil   = {() => this.props.navigation.navigate('detil', { data: item, airlineGroup: item.airlineCode, slug: this.state.type })}
                ...
                <View style={s.filter_bar}>
                    ...
                    <Touchable onPress={() => this.props.navigation.navigate('FlightSortFilter', {
