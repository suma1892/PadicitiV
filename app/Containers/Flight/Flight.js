...
export default class Flight extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            { return_date: moment(new Date()).add(3, 'day').format('YYYY-MM-DD')},
            {
                depart: {
                    code: 'CGK',
                    title: 'Jakarta (CGK)',
            ...
            },
            {
                return: {
                    code: 'DPS',
                    title: 'Denpasar (DPS)',
                    sub_title: 'Ngurah Rai',
                    group_code : 'SJ-MZ-JT-GA-QG-SY-QZ-RI-1B-MV-KD'
                },
            },
            { airlineGroup: null },
            { selectedItem: '' }],
    ...
    componentDidMount() {
        ...
        AsyncStorage.getItem('TripFlight', (err, TripFlight) => {
            if (TripFlight !== null) {
    ...
    action() {
        Function.SaveDataJson('SearchFlight', Function.JsonString(this.state.params))
        Function.SaveDataJson('TripFlight', Function.JsonString(this.state.radioItems))
        this.props.navigation.navigate('ScheduleFlight', { parameter: this.state.params, ActivityResult : this.ActivityResult })
    }
    render() {
        ...
        return (
            ...
            <View style={{ flex: 1, backgroundColor: Colors.white }} >
                <Toolbar
                    ...
                    View={
                        <TextView style={styles.title}>Pesawat</TextView>
                    }
                />
                <ScrollView
                    ...
                    <View >
                        ...
                        <View style={{ marginTop: Scale(14), marginLeft: Scale(16), marginRight: Scale(16) }}>
                            ...
                            <FrameRadiusComponent
                                View={
                                    <TouchableComponent style={styles.touchable}
                                        onPress={() => this.props.navigation.navigate('AirportList', { slug: 'return', ActivityResult: this.ActivityResult })}>
                                        <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                            <Image
                                                style={[styles.flightFrom]}
                                                resizeMethod='scale'
