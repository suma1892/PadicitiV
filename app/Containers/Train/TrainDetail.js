...
export default class TrainSchedule extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <View style={s.container} >
                <Toolbar  
                    ...
                    <View>
                        <Text style={s.toolbar_title}>{STRING.Label.train_detail}</Text>
                    </View>
                </Toolbar>
                <View style={{flex:1}}>
                    ...
                    <View style={s.train_routes_section}>
                        <Text style={s.train_name}>{data.train_name} - {data.train_no}</Text>
                        <View>
                            <View style={s.route_section}>
                                ...
                                <View style={s.route_time_date}>
                                    ...
                                    <Text style={s.route_date}>{moment(data.dep_date, 'YYYYMMDD').format('DD MMM')}</Text>
                                </View>
                                <View>
                                    <Text style={s.route_station}>{STRING.Label.station} {data.org} ({data.org_code})</Text>
                                </View>
                            </View>
                            <View style={s.route_section}>
                                ...
                                <Text style={s.route_duration}>{data.duration_string}, {STRING.Label.directly}</Text>
                            </View>
                            <View style={s.route_section}>
                                ...
                                <View>
                                    <Text style={s.route_station}>{STRING.Label.station} {data.des} ({data.des_code})</Text>
                                </View>
                            </View>
                        </View>
                    </View>
                ...
                <View style={s.summary_section}>
                    <View style={{flex:1}}>
                        <Text style={s.summary_title_desc}>{STRING.Label.price_poeple}</Text>
                    </View>
                    <View style={{flex:1}}>
                        <Text style={s.summary_price}>IDR {Function.convertToPrice(data.price || 0)}</Text>
                    </View>
                </View>
            </View>
        )
...
AppRegistry.registerComponent("padiciti", () => TrainSchedule);
