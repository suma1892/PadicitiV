...
export default class BusSortFilter extends Component {
    constructor(props) {
        super(props);
        this.state = {
            time_value  : null,
    ...
    componentDidMount() {
        ...
        this.setState({
            sort_value: state.params.sort_value || 'price_asc',
            time_value  : state.params.time_value,
            class_value : state.params.class_value,
            train_value : state.params.train_value,
            sort_value  : state.params.sort_value
        })
    }
            ...
            <View style={s.container}>
                <Toolbar  
                    ...
                    <View style={{flex:1, flexDirection: 'row'}}>
                        <Text style ={s.toolbar_title}>{STRING.Function_name.sort.toLowerCase()}</Text>
                ...
                {state.params && state.params.slug === 'filter' && <ScrollView>
                    ...
                    <Text style={s.title_section}>{STRING.Function_name.class}</Text>
                    ...
                    <Text style={s.title_section}>{STRING.Function_name.train_name}</Text>
                    {Function.find_duplicate_in_array(state.params.train_name).map((item, index) => (
                            <ItemListCheckBox 
                                key     = {index}
...
AppRegistry.registerComponent("padiciti", () => BusSortFilter);
