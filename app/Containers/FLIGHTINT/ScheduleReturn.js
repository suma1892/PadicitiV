        ...
        return (
            <View style={{ flex: 1, }}>
                        ...
                        renderItem={({ item }) => (
                            <View>
                                ...
                                <ItemListSchedulrFlight
                                    onPress={() => this.props.navigation.navigate('ReviewINT', { dataReturn: item, dataDepart: params.dataDepart, slug: 'return' })}
                                    onpress_detil={() => this.props.navigation.navigate('detilINT', { data: item, airlineGroup: item.airlineCode, slug: 'return' })}
                ...
                <View style={s.filter_bar}>
                    ...
                    <Touchable onPress={() =>  this.props.navigation.navigate('FlightSortFilterINT', {slug: 'filter', groupFligthFilter : this.state.groupFligthFilter, 
